...
if file_uploader is not None:
    ...
    with st.sidebar.beta_expander("Signal 1", expanded=True):
        ...
        function_1   = st.multiselect('Functions', ['times_2','example:rms2peak','example:rollingaverage'], key="function_1" )
