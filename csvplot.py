...
with st.beta_expander("📝 To Do"):
    ...
    st.write("- Plotted data table generation")
    st.write("- Multi Y axis")
    st.write("- Rename signal")
    st.write("- Add functions")
    st.write("- Allow deletion of annotation/shapes")
    st.write("- Export as HTML")
    st.write("- Add Line/maker styles")
    st.write("- Make .exe")
...
checkbox_table = st.checkbox('Display selected data as table')
checkbox_raw_table = st.checkbox('Display raw data as table')
